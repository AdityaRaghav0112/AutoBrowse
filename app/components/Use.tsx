    ...
    <section id="demo" className="py-24 px-4 relative z-10 font-sans">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <div className="relative bg-black/60 backdrop-blur-3xl border border-white/10 rounded-3xl flex flex-col md:flex-row shadow-2xl focus-within:ring-1 focus-within:ring-brand-cyan/50 transition-all items-end">
            <textarea
              ref={textareaRef}
              value={prompt}
            ...
            <button 
              ...
              className="md:mt-0 mt-4 w-full md:w-auto bg-gradient-to-r from-brand-blue to-brand-purple text-white p-5 m-2 rounded-2xl flex items-center justify-center transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(157,78,221,0.6)] md:ml-2 font-bold tracking-wider disabled:opacity-50 disabled:pointer-events-none"
            >
